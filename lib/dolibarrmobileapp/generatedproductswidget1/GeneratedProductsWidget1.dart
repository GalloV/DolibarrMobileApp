...
class GeneratedProductsWidget1 extends StatelessWidget {
  Future<List<product_data>> makeRequest(
      BuildContext context, String sessiontoken) async {
    final LocalStorage storage = LocalStorage("dolibarLocal");

    String url =
        'https://tpdolibarr.with3.dolicloud.com/api/index.php/products';
    ...
    for (var i = 0; i < products.length; i++) {
      ...
      myList
          .add(product_data(item["label"], item["description"], item["price"]));
    }
  ...
  Widget build(BuildContext context) {
    final sessionToken = ModalRoute.of(context)!.settings.arguments != null
